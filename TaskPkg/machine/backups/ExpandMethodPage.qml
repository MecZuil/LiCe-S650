...
Rectangle {
    id: expand_method
    x: change_model.is_640x480_size() ? 200 : 85
    y: change_model.is_640x480_size() ? 136 : 58
    width: change_model.is_640x480_size() ? 400 : 310
    height: change_model.is_640x480_size() ? 250 : 165
    visible: false
    color: "#7CA6C9"
