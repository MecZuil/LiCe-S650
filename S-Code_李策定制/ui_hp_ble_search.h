/********************************************************************************
** Form generated from reading UI file 'hp_ble_search.ui'
**
...
#ifndef UI_HP_BLE_SEARCH_H
#define UI_HP_BLE_SEARCH_H
...
public:
    ...
    void setupUi(QWidget *Hp_Ble_Search)
    {
        if (Hp_Ble_Search->objectName().isEmpty())
            Hp_Ble_Search->setObjectName(QStringLiteral("Hp_Ble_Search"));
        Hp_Ble_Search->resize(800, 480);
        Hp_Ble_Search->setStyleSheet(QStringLiteral("background-image:url(:/res/res/setting_background.png);"));
        frame = new QFrame(Hp_Ble_Search);
...
"color:gray;\n"
"}"));
        frame_2 = new QFrame(Hp_Ble_Search);
...
"background:transparent;"));
        ...
        retranslateUi(Hp_Ble_Search);
        QObject::connect(toolButton_back, SIGNAL(released()), Hp_Ble_Search, SLOT(close()));

        QMetaObject::connectSlotsByName(Hp_Ble_Search);
    } // setupUi

    void retranslateUi(QWidget *Hp_Ble_Search)
    {
        Hp_Ble_Search->setWindowTitle(QApplication::translate("Hp_Ble_Search", "Form", nullptr));
        toolButton_back->setText(QString());
        toolButton_connect->setText(QApplication::translate("Hp_Ble_Search", "\350\277\236\346\216\245\350\200\263\346\234\272", nullptr));
        toolButton_search->setText(QApplication::translate("Hp_Ble_Search", "\346\220\234\347\264\242\350\200\263\346\234\272", nullptr));
        toolButton_disconnect->setText(QApplication::translate("Hp_Ble_Search", "\346\226\255\345\274\200\350\200\263\346\234\272", nullptr));
        label_2->setText(QApplication::translate("Hp_Ble_Search", "\345\267\262\351\205\215\345\257\271\350\256\276\345\244\207\357\274\232", nullptr));
        pushButton->setText(QApplication::translate("Hp_Ble_Search", "\345\210\267\346\226\260", nullptr));
        label->setText(QString());
        label_3->setText(QApplication::translate("Hp_Ble_Search", "\345\217\257\347\224\250\350\256\276\345\244\207\357\274\232", nullptr));
    } // retranslateUi

};

namespace Ui {
    class Hp_Ble_Search: public Ui_Hp_Ble_Search {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_HP_BLE_SEARCH_H
