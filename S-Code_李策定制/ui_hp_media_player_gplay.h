/********************************************************************************
** Form generated from reading UI file 'hp_media_player_gplay.ui'
**
...
#ifndef UI_HP_MEDIA_PLAYER_GPLAY_H
#define UI_HP_MEDIA_PLAYER_GPLAY_H
...
class Ui_Hp_Media_Player_Gplay
{
public:
    ...
    void setupUi(QWidget *Hp_Media_Player_Gplay)
    {
        if (Hp_Media_Player_Gplay->objectName().isEmpty())
            Hp_Media_Player_Gplay->setObjectName(QStringLiteral("Hp_Media_Player_Gplay"));
        Hp_Media_Player_Gplay->resize(800, 480);
        frame_display = new QFrame(Hp_Media_Player_Gplay);
        frame_display->setObjectName(QStringLiteral("frame_display"));
        frame_display->setGeometry(QRect(160, 0, 640, 480));
        QFont font;
...
"}  "));
        ...
        frame_control = new QFrame(Hp_Media_Player_Gplay);
...
""));
        ...
        toolButton_pause->setGeometry(QRect(3, 80, 150, 70));
...
""));
        ...
        retranslateUi(Hp_Media_Player_Gplay);

        QMetaObject::connectSlotsByName(Hp_Media_Player_Gplay);
    } // setupUi

    void retranslateUi(QWidget *Hp_Media_Player_Gplay)
    {
        Hp_Media_Player_Gplay->setWindowTitle(QApplication::translate("Hp_Media_Player_Gplay", "Form", nullptr));
...
namespace Ui {
    class Hp_Media_Player_Gplay: public Ui_Hp_Media_Player_Gplay {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_HP_MEDIA_PLAYER_GPLAY_H
